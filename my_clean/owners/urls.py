...
from .views import \
    ...
    STLTaskView, TLTaskView, EvaluationView, \
...
urlpatterns = [
    ...
    path('stl_task_view/', STLTaskView.as_view(), name='stl_task_view'),
    path('stl_review/<int:pk>/<int:task_id>/', STLReview.as_view(), name='stl_review'),
